/* @ts-self-types="./tress_wasm.d.ts" */

/**
 * An agent session backed by an in-memory workspace.
 */
export class TressSession {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        TressSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_tresssession_free(ptr, 0);
    }
    /**
     ...
     */
    files() {
        const ret = wasm.tresssession_files(this.__wbg_ptr);
        if (ret[2]) {
     ...
     * @param {any} files
     */
    constructor(url, model, headers, files) {
        const ptr0 = passStringToWasm0(url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(model, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.tresssession_new(ptr0, len0, ptr1, len1, headers, files);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        TressSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    send(prompt, on_event) {
        const ptr0 = passStringToWasm0(prompt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.tresssession_send(this.__wbg_ptr, ptr0, len0, on_event);
        return ret;
    }
}
if (Symbol.dispose) TressSession.prototype[Symbol.dispose] = TressSession.prototype.free;
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_6f8b0d724fe26c07: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__hde0a17d4b3668875(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_generic_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h2d963d42c4f31cc8);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./tress_wasm_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h2d963d42c4f31cc8(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h2d963d42c4f31cc8(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__hde0a17d4b3668875(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__hde0a17d4b3668875(arg0, arg1, arg2, arg3);
}

const TressSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_tresssession_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tress_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
